  ...
  Welcomescreen = function (slides, options) {
    ...
    var self = this,
      ...
      defaults = {
        ...
        closeButtonText : 'Fermer', // close button text
        ...
        parallax: true,          // adds parallax capabilities
        parallaxSpeed: 600,       // parallax default speed
        parallaxBackgroundImage: 'Welcome-Screen/welcome.png', // parallax default background image
    ...
    function defineDefaultTemplate() {
      defaultTemplate = '<div class="welcomescreen-container {{#if options.cssClass}}{{options.cssClass}}{{/if}}">' +
          '<div height="100%" id="map_canvas"></div>'+
          '{{#if options.closeButton}}' +
          '<div style="color:#4527a0" onclick="location.reload()" class="welcomescreen-closebtn close-welcomescreen">{{options.closeButtonText}}</div>' +
          '{{/if}}' +
